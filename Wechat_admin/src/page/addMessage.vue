        ...
        <div class="form-box" style="width: 100%;">
            <el-form ref="form" :rules="rules" label-position="right" :model="form" label-width="80px">
                <div class="one_row">
                    ...
                    <el-form-item class="row_right" label="业主电话" prop="userPhoen">
                        <el-input v-model="form.userPhoen" clearable></el-input>
                    </el-form-item>
                </div>
                <div class="one_row">
                    <el-form-item label="业主地址" prop="userAddress">
                ...
                <el-form-item label="上传图片">
                    <el-upload target="tg" name="myfile" id="myfile" class="upload-demo" drag :action="uploadUrl" list-type="picture" multiple :file-list="fileList" :on-success="uploadSuccess" :on-error="uploadError" :on-remove="removeFile" :before-upload="beforeUpload">
        ...
        beforeUpload(file) {
            ...
            return new Promise(async (resolve, reject) => {
                ...
                if (file['size'] > 2 * 1024 * 1024) {
                    let _base = await this.compressImg(file);
                    let _file = this.dataURLtoFile(_base, file.name);
                    file = _file;
				}
				resolve(file);
            })
            ...
            return new Promise((resolve) => {
                ...
                reader.onload = (e) => {
                    ...
                    image.onload = () => {
                        ...
                        let base = canvas.toDataURL(this.getMimeType(_r), quality);
                        resolve(base);
                    };
                }
            });
