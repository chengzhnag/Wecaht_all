    ...
    <div class="table">
        ...
        <div class="container">
            <el-table :data="tableData" border class="table" ref="multipleTable" @selection-change="handleSelectionChange">
                ...
                <el-table-column align='center' prop="landTime" label="登陆时间" width="180">
                </el-table-column>
                <el-table-column align='center' prop="landIp" label="登陆IP" width="180">
                </el-table-column>
                <el-table-column align='center' prop="operationText" label="操作">
                </el-table-column>
                <el-table-column align='center' prop="permissions" label="权限" width="90">
                </el-table-column>
            </el-table>
...
export default {
    ...
    methods: {
        ...
        getData() {
            this.$axios.get(this.$commonapi.operationLog, {
                params: {
